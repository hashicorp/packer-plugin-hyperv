...
import (
	...
	"github.com/hashicorp/packer-plugin-hyperv/builder/hyperv/common"
...
type FlatConfig struct {
	...
	SwitchConfigs                  []common.FlatSwitchConfig  `mapstructure:"switch_config" required:"false" cty:"switch_config" hcl:"switch_config"`
	AdapterConfigs                 []common.FlatAdapterConfig `mapstructure:"adapter_config" required:"false" cty:"adapter_config" hcl:"adapter_config"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"switch_config":                    &hcldec.BlockListSpec{TypeName: "switch_config", Nested: hcldec.ObjectSpec((*common.FlatSwitchConfig)(nil).HCL2Spec())},
		"adapter_config":                   &hcldec.BlockListSpec{TypeName: "adapter_config", Nested: hcldec.ObjectSpec((*common.FlatAdapterConfig)(nil).HCL2Spec())},
