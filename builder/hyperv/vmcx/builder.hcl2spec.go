...
type FlatConfig struct {
	...
	ComPortPipePath                *string           `mapstructure:"com_port_pipe_path" required:"false" cty:"com_port_pipe_path" hcl:"com_port_pipe_path"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"com_port_pipe_path":               &hcldec.AttrSpec{Name: "com_port_pipe_path", Type: cty.String, Required: false},
